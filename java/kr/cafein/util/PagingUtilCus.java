...
public class PagingUtilCus {
	 ...
	 * */
	public PagingUtilCus(int currentPage, int totalCount, int rowCount,
	...
	public PagingUtilCus(String keyfield, String keyword, int currentPage, int totalCount, int rowCount,
			int pageCount,String pageUrl) {
