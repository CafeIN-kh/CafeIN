...
public class CustomizingDetailCommand {
	...
	public String toString() {
		return "CustomizingDetailCommand [custom_num=" + custom_num + ", franchise_num=" + franchise_num + ", u_uid="
				+ u_uid + ", custom_name=" + custom_name + ", custom_introduce=" + custom_introduce + ", custom_recipe="
				+ custom_recipe + ", custom_img=" + custom_img + ", custom_hash_tag=" + custom_hash_tag + ", upload="
				+ upload + ", custom_visit=" + custom_visit + ", custom_reg_date=" + custom_reg_date + ", u_name="
				+ u_name + ", franchise_name=" + franchise_name + ", start=" + start + "]";
	}
