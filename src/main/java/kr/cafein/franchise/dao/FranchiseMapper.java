...
public interface FranchiseMapper {
	...
	//프랜차이즈 좋아요 클릭
	@Insert("INSERT INTO u_like(like_num, u_uid, franchise_num, like_reg_date) VALUES (u_like_seq.nextval, #{u_uid}, #{franchise_num}, sysdate)")
	...
	//메뉴 좋아요 클릭
	@Insert("INSERT INTO u_like(like_num, u_uid, fmenu_num, like_reg_date) VALUES (u_like_seq.nextval, #{u_uid}, #{fmenu_num}, sysdate)")
