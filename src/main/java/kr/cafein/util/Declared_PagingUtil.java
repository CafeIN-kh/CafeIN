...
public class Declared_PagingUtil {
	 ...
	 * */
	public Declared_PagingUtil(int currentPage, int totalCount, int rowCount,
	...
	public Declared_PagingUtil(String keyfield, String keyword, int currentPage, int totalCount, int rowCount,
			int pageCount,String pageUrl) {
