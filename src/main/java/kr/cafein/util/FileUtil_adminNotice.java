...
public class FileUtil_adminNotice {
	...
	//메타데이터에 저장(새로고침없이 저장)
	public static String UPLOAD_PATH="D:/Program Files/Development/spring_project/workspace_mars/.metadata/.plugins/org.eclipse.wst.server.core/tmp5/wtpwebapps/CafeIN/upload/notice";
