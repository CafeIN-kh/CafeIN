...
<div class="card">
	<div class="card-header">
		<h2>
			Admin Notice <small>Write Post</small>
		</h2>
	</div>
<form:form action="write.do" id="admin_notice_modify_form" enctype="multipart/form-data" commandName="admin_noticeCommand">
	...
	<div class="card-body card-padding">	
		...
		<div class="row" style="margin-left: 15px;">
            ...
            <div class="fileinput fileinput-new"  data-provides="fileinput">
                ...
                <%-- 	<img src="${pageContext.request.contextPath}/resources/cafein_admin/img/event/${eventCommand.event_img}" alt="">  --%>
                </div>
				<div class="row">
