 ...
 <section id="content">
                ...
                <div class="pm-body clearfix">
                             <ul class="tab-nav tn-justified">
                                <li class=" waves-effect"><a href="${pageContext.request.contextPath }/cafein_admin/franchise/franchise_brandLogList.do">Admin Log</a></li>
                                <li class="active waves-effect"><a href="${pageContext.request.contextPath }/cafein_admin/franchise/franchise_brandUserLogList.do">User Log</a></li>
