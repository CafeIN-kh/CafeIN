                            ...
                            <div class="col-md-3 col-sm-6">
                                <div id="best-selling" class="dash-widget-item">
                                    <div class="dash-widget-header">
                                        ...
                                        <img src="${pageContext.request.contextPath}/resources/cafein_admin/img/widgets/alpha.jpg" alt="">
                                        <div class="main-item">
                                    ...
                                    <div class="listview p-t-5">
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="${pageContext.request.contextPath}/resources/cafein_admin/img/widgets/note4.jpg" alt="">
                                                </div>
                                        ...
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="${pageContext.request.contextPath}/resources/cafein_admin/img/widgets/mate7.jpg" alt="">
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="${pageContext.request.contextPath}/resources/cafein_admin/img/widgets/535.jpg" alt="">
                                                </div>
                                                <div class="media-body">
