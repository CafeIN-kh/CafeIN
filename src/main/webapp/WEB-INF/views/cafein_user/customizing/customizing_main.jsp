         ...
         <form action="customizing_list.do" >
            <div class="input-group">
                  ...
                  <span class="input-group-btn">
                     <select id="selectBox" name="keyfield" class="btn-u btn-u-lg korean-font" style="padding:8; height:48px; width:auto;">
                              <option value="all">전체</option>
                              <option value="custom_name">메뉴이름</option>
...
<div class="cube-portfolio container">
   ...
   <div class="btn-group" style="float: right;">
            ...
            <ul class="dropdown-menu">
               ...
               <c:if test="${map.u_uid!=null }">
               <li class="korean-font"><a href="customizing_list.do?category=4&keyfield=${map.keyfield}&keyword=${map.keyword}">나의 등록글</a></li>
               </c:if>
            </ul>
         </div>
      </div>
                  ...
                  <div class="modal-dialog">
                      <div class="modal-content">
                          <div class="modal-header">
                              ...
                              <h4 class="modal-title korean-font" id="myModalLabel4">메뉴등록</h4>
                          </div> 
...
<div class="cube-portfolio container margin-bottom-60">
   <div class="content-xs">
      <div id="filters-container" class="cbp-l-filters-text content-xs">
         ...
         |
      <c:if test="${count == 0}">
      <!-- <div class="align-center" style="margin-bottom:15%">등록된 게시물이 없습니다.</div> -->
      ...
      <!--/end Filters Container-->
               ...
               <!--커스터마이징 하면 카드가 붙는 부분  -->
<div id="grid-container" class="cbp-l-grid-agency" style="margin-bottom:10%;">
<c:if test="${count == 0}">
