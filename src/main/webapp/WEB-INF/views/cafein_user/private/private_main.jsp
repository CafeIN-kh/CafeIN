    	...
    	<div class="row blog-page">    
        	...
        	<div class="col-md-12 md-margin-bottom-40">
		        ...
		        <div class="text-center margin-bottom-50">
	                ...
	                <p class="space-lg-hor korean-font">전국의 개인카페애 대한 정보가 들어있습니다. <span class="color-green">원하는 카페를 선택하여 들어가시면</span>, 더 많은 정보를 보실 수 있습니다.<br> 내글보기를 누르시면 삭제 버튼이 생성됩니다.</p>
	            </div>
