...
Insert into FRANCHISE (FRANCHISE_NUM,FRANCHISE_NAME,FRANCHISE_IMG,FRANCHISE_INTRODUCE,FRANCHISE_VISIT) values (franchise_seq.nextval,'ediya','ediya.png','고객을 향한 진심 이디야 커피
...
Insert into FRANCHISE (FRANCHISE_NUM,FRANCHISE_NAME,FRANCHISE_IMG,FRANCHISE_INTRODUCE,FRANCHISE_VISIT) values (franchise_seq.nextval,'hollys','hollys.png','다양한 토양과 기후에서 자란 커피 원두는 그 속에 각기 다른 맛과 향의 비밀을 숨기고 있습니다.
...
Insert into FRANCHISE (FRANCHISE_NUM,FRANCHISE_NAME,FRANCHISE_IMG,FRANCHISE_INTRODUCE,FRANCHISE_VISIT) values (franchise_seq.nextval,'pascucci','pascucci.png','1883년 이탈리아 몬테펠트로에서 탄생한 카페 파스쿠찌. 현재 이태리, 영국, 스페인,
